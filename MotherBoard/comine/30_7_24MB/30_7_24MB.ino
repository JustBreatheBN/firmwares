...
HardwareSerial hc12Serial(3);  // Use UART1
...
void setup() {
  Serial.begin(115200);
  hc12Serial.begin(9600, SERIAL_8N1, 13, 12); // Initialize Serial2 for HC-12 communication
  rbSerial.begin(9600, SERIAL_8N1, 10, 9);
  Wire.begin(1, 2);
